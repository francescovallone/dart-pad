...
import 'package:dart_services/utils.dart' as utils;
...
class AnalyzerService extends Provider with OnApplicationInit {
  ...
  AnalyzerService(this.sdk);

  @override
  Future<void> onApplicationInit() async {
    analysisServer = AnalysisServerWrapper(_logger, sdkPath: sdk.dartSdkPath);
...
class AnalysisServerWrapper {
  ...
  AnalysisServerWrapper(this._logger, {required this.sdkPath, String? projectPath})
  ...
  Future<api.FormatResponse> format(String src, int? offset) {
    return _formatImpl(src, offset)
        ...
        .catchError((dynamic error) {
          _logger.verbose('format error: $error');
...
extension AnnotatedNodeExtension on AnnotatedNode {
  api.Location getLocation(String source) {
    final lines = utils.Lines(source);
